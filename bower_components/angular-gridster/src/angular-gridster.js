			...
			return {
				...
				compile: function($tplElem) {
					...
					return function(scope, $elem, attrs, gridster) {
						...
						$win.on('resize', /* function(){alert("resize"); */onResize/* ()} */);
						//scope.$on('$stateChangeSuccess', function(){alert("ddd");onResize()});
                        //$rootScope.$broadcast("ChangeSuccess"); 
						// be sure to cleanup
